          ...
          <template scope="props">
            ...
            <el-popover ref="popover4" placement="left-start" width="620" trigger="click">
              <div style="margin-left:10px;font-size:15px">
                <i class="el-icon-date" style="color:#20A0FF"></i> <span
                style="margin-left:8px;color:#20A0FF">项目详情</span>
              </div>
                ...
                <div class="loginWarpa">
                  <div class="login-forma">
                    <el-form ref="form" label-width="0">
                      ...
                      <el-form-item prop="old_password" class="login-itema" style="margin-top:-20px;margin-left:-25px">
                        <label>项目环境 ：</label> <span
                        style="color:teal">{{project_data.Level == 3 ? '线上环境' : '预发布环境'}}</span>
                      </el-form-item>
                      <el-form-item prop="old_password" class="login-itema" style="margin-top:-20px;margin-left:-25px">
              ...
              <div style="margin-left:10px;font-size:15px">
                <i class="ace-icon fa fa-desktop" style="color:#F7BA21"></i> <span
                style="margin-top:-20px;margin-left:8px;color:#F7BA2A">宿主机</span>
              </div>
              <div class="login-bodya">
                <div class="loginWarpa">
                  <div class="login-forma">
              ...
              <div style="margin-left:10px;font-size:15px">
                <i class="el-icon-menu" style="color:#13CE66"></i> <span
                style="margin-top:-20px;margin-left:8px;color:#13CE66">机器列表</span>
              </div>
              <div class="login-bodya">
                <div class="loginWarpa">
                  <div class="login-forma">
              ...
              <div style="margin-left:10px;font-size:15px">
                <i class="el-icon-setting" style="color:#FF4949"></i><span
                style="margin-top:-20px;margin-left:8px;color:#FF4949">高级任务</span>
              </div>
              <div class="login-bodya">
                <div class="loginWarpa">
                  <div class="login-forma">
            ...
            <el-button style="margin-left:0px" type="danger" size="small" icon="delete"
...
<script type="text/javascript">
  import {bottomToolBar, panelTitle, search} from 'components'
